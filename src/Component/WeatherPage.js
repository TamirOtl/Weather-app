...

{
    ...
    return(
       ...
       <header >
         ...
         <img className="list-item__sub-title" alt="icon" src={`http://openweathermap.org/img/wn/${props.weather.weather[0].icon}@2x.png`}/>
        <div>
        <div className="list-headerforcast">
           
        <span><h5 >Now</h5><img className="list-item__sub-title"  alt="icon" src={`http://openweathermap.org/img/wn/${props.full.hourly[0].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(1,"hour").format("h a")}</h5><img  alt="icon" className="list-item__sub-title" alt="icon" src={`http://openweathermap.org/img/wn/${props.full.hourly[1].weather[0].icon}@2x.png`}/><br/>
       ...
       moment.tz(props.full.timezone).add(1,"hour").format("h a")===moment(props.full.current.sunrise*1000).tz(props.full.timezone).format("h a")?<p><img className="sunrise" src='../Images/sunrise.png' alt="Sunrise"/>Sunrise</p> :""}</span>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(2,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[2].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(3,"hour").format("h a")}</h5><img alt="icon"className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[3].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(4,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[4].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(5,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[5].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(6,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[6].weather[0].icon}@2x.png`}/><br/>
       ...
       moment.tz(props.full.timezone).add(6,"hour").format("h a")===moment(props.full.current.sunrise*1000).tz(props.full.timezone).format("h a")?<p><img className="sunrise" src='../Images/sunrise.png' alt="Sunrise"/>Sunrise</p> :""}</span>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(7,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[7].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(8,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[8].weather[0].icon}@2x.png`}/><br/>
       ...
       moment.tz(props.full.timezone).add(8,"hour").format("h a")===moment(props.full.current.sunrise*1000).tz(props.full.timezone).format("h a")?<p><img className="sunrise" src='../Images/sunrise.png' alt="Sunrise"/>Sunrise</p> :""}</span>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(9,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[9].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(10,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[10].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(11,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[11].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(12,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[12].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(13,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[13].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(14,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[14].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(15,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[15].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(16,"hour").format("h a")}</h5><img  className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[16].weather[0].icon}@2x.png`} alt="icon"/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(17,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[17].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(18,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[18].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(19,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[19].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(20,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[20].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(21,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[21].weather[0].icon}@2x.png`}/><br/>
       ...
       moment.tz(props.full.timezone).add(21,"hour").format("h a")===moment(props.full.current.sunrise*1000).tz(props.full.timezone).format("h a")?<p><img className="sunrise" src='../Images/sunrise.png' alt="Sunrise"/>Sunrise</p> :""}</span>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(22,"hour").format("h a")}</h5><img alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[22].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(23,"hour").format("h a")}</h5><img  alt="icon" className="list-item__sub-title" src={`http://openweathermap.org/img/wn/${props.full.hourly[23].weather[0].icon}@2x.png`}/><br/>
       ...
       moment.tz(props.full.timezone).add(23,"hour").format("h a")===moment(props.full.current.sunrise*1000).tz(props.full.timezone).format("h a")?<p><img className="sunrise" src='../Images/sunrise.png' alt="Sunrise"/>Sunrise</p> :""}</span>
        ...
        <span><h5 >{moment.tz(props.full.timezone).add(24,"hour").format("h a")}</h5><img className="list-item__sub-title" alt="icon" src={`http://openweathermap.org/img/wn/${props.full.hourly[24].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment().add(1,"day").format("dddd")}</h5><img className="list-item__sub-title" alt="icon" src={`http://openweathermap.org/img/wn/${props.full.daily[1].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment().add(2,"day").format("dddd")}</h5><img className="list-item__sub-title" alt="icon" src={`http://openweathermap.org/img/wn/${props.full.daily[2].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment().add(3,"day").format("dddd")}</h5><img className="list-item__sub-title" alt="icon" src={`http://openweathermap.org/img/wn/${props.full.daily[3].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment().add(4,"day").format("dddd")}</h5><img className="list-item__sub-title" alt="icon" src={`http://openweathermap.org/img/wn/${props.full.daily[4].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment().add(5,"day").format("dddd")}</h5><img className="list-item__sub-title" alt="icon"src={`http://openweathermap.org/img/wn/${props.full.daily[5].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment().add(6,"day").format("dddd")}</h5><img className="list-item__sub-title" alt="icon" src={`http://openweathermap.org/img/wn/${props.full.daily[6].weather[0].icon}@2x.png`}/><br/>
        ...
        <span><h5 >{moment().add(7,"day").format("dddd")}</h5><img className="list-item__sub-title"alt="icon" src={`http://openweathermap.org/img/wn/${props.full.daily[7].weather[0].icon}@2x.png`}/><br/>
